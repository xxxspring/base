package io.github.xxxspring.base.constant;
...
public class CommonConstants {
    ...
    public static final String  JWT_KEY_NONCE            = "nonce";
    // token redis black list key
    public static final String  JWT_BLACK_LIST_TOKEN_KEY = "auth:token:blacklist";
}
